...
public class UIUtils {
    ...
    public static JButton navigationButton(String text,int index){
        ...
        b.setContentAreaFilled(false);b.setOpaque(false);b.setForeground(WHITE);b.setFont(new Font("Tahoma",Font.PLAIN,14));b.setHorizontalAlignment(SwingConstants.LEFT);b.setFocusPainted(false);b.setBorder(new EmptyBorder(11,12,11,8));b.setIcon(new NavigationIcon(index));b.setIconTextGap(11);b.setMaximumSize(new Dimension(Integer.MAX_VALUE,44));b.setPreferredSize(new Dimension(216,44));b.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));return b;
    }
    public static void selectNavigation(JButton b,boolean selected){b.putClientProperty("nav.selected",selected);b.setFont(new Font("Tahoma",selected?Font.BOLD:Font.PLAIN,14));b.repaint();}
